// Kumpulan icon custom (SVG inline) — pengganti lucide-react
// Tidak bergantung pada library eksternal, jadi tidak akan pernah
// bermasalah karena versi package berubah.
